...
def cista_threads_googlechat():
    ...
    req = urllib.request.Request(
        url=signal_base_url + "/api/v2/provide/threads.json?" + p, method="GET"
    )
...
if __name__ == "__main__":
    ...
    logger = logging.getLogger("cista-threads-googlechat")
    cista_threads_googlechat()
